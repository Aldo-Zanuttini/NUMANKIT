...
# number_of_points..............................the total number of points in the discretization
#                                               (Int64)
# INPUTS (optional)
# stretching_factor.............................a factor by which the grid is to be stretched
#                                               (Float64)
# region_of_interest............................a string saying which area of the grid is 
#                                               supposed to have more points (possible values: 
#                                               "right boundary", "left boundary", "boundaries" 
#                                               and "center")
# OUTPUTS a named tuple with names:
# .points.......................................a Vector{Float64} containing the gridpoints
# .volumes_plus.................................a Vector{Float64} containing the volumes 
#                                               (including the volume outside the boundary in 
#                                               the positive direciton)
# .volumes_minus................................a Vector{Float64} containing the volumes 
#                                               (including the volume outside the boundary in the
#                                               negative direciton)
# .volumes_central..............................a Vector{Float64} containing the volumes (excl.
#                                               boundaries)
# .boundary_volume..............................the volume outside the domain (Float64, assumed 
...
# INPUTS (compulsory)
# operator......................................a string describing what operator is to be discretized
#                                               ("convection" or "diffusion")
# grid..........................................a named tuple produced by the mkgrid function
# boundary_conditions...........................a named tuple (plus="neumann/dirichlet/robin", 
#                                               minus="neumann/dirichlet/robin") describing what type
#                                               of homogeneous boundary condition is to be used at
#                                               each end of the domain. When choosing robin
#                                               conditions, the form
#                                                                      u+b*u_x=0
#                                               is assumed, in which case the named tuple must also
#                                               contain the name
#                                                                       coeff=b.
#                                               If a name is not in the set {dirichlet, neumann,
#                                               robin} then no boundary conditions will be applied on
#                                               that end of the domain.
# INPUTS (optional)
# grid1, grid2..................................grids for the other physical dimensions of the problem
# boundary_conditions1, boundary_conditions2....boundary conditions for other physical dimension of the
#                                               problem
# OUTPUTS (1D)
